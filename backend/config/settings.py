...
DATABASES = {
    'default': dj_database_url.config(
        default=os.environ.get('DATABASE_URL', 'postgresql://interview_user:interview_password@localhost:5432/interview_platform')
    )
}
...
DEFAULT_FROM_EMAIL = os.environ.get('FROM_EMAIL', 'noreply@yourcompany.com')
